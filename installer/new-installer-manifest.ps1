...
$actual = [Diagnostics.FileVersionInfo]::GetVersionInfo((Resolve-Path -LiteralPath $Installer)).FileVersion
if ([version]$actual -ne [version]("$Version.0")) { throw 'Installer file version does not match the release version.' }
