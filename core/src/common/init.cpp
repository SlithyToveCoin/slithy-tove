// Copyright (c) 2023-present The Slithy Tove Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // slithy.conf file just ignores the other file.)
        ...
        // Show an error or warn/log if there is a slithy.conf file in the
