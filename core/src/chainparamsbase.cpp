...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 43426);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("beta-20260909", 53426);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 54426);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 55426);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 63426);
    }
    assert(false);
}
